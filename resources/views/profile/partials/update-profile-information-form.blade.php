        ...
        <div class="flex items-center gap-4 mt-4">
            ...
            <div class="flex-1">
                ...
                <div class="relative mt-1">
                    ...
                    <x-text-input id="hourly_rate" name="hourly_rate" type="number" step="0.01" min="0" class="mt-0 block w-full pl-14 cursor-not-allowed opacity-75" :value="isset($user->hourly_rate) ? number_format($user->hourly_rate, 2) : ''" disabled />
                </div>
            </div>
        </div>
