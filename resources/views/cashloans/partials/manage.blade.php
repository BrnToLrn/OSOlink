            ...
            <tbody class="divide-gray-200 dark:bg-gray-900 text-sm">
                @forelse ($loans as $loan)
                    <tr>
                        ...
                        <td class="px-4 py-2 text-center font-medium text-gray-700 dark:text-gray-200">
                            <a href="{{ route('cashloans.edit', $loan) }}" class="text-green-600 dark:text-green-400 hover:underline">Edit</a>
                            <form action="{{ route('cashloans.destroy', $loan) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
